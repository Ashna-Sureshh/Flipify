...
namespace Flipify
{
    public partial class Edit_product : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowUpdating1(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string upd = "update Product_tab set Product_name='" + txtname.Text + "',Product_description='" + txtdescription.Text + "',Product_price=" + txtprice.Text + ",Product_stock=" + txtstock.Text + "";
            if (fileUpload != null && fileUpload.HasFile)
            {
                string path1 = "~/product image/" + fileUpload.FileName;
                fileUpload.SaveAs(MapPath(path1));

                upd += ", Product_image = '" + path1 + "'";
            }

            upd += " where Product_id = " + getid+"";
